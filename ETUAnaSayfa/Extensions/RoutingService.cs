...
public static class RoutingService
{
    ...
    private static IEndpointRouteBuilder AddNavStudentRouting(this IEndpointRouteBuilder endpoints)
    {
        endpoints.MapControllerRoute(
            name: "UniversityLogo",
    ...
    private static IEndpointRouteBuilder AddCustomRouting(this IEndpointRouteBuilder endpoints)
    {
        endpoints.MapControllerRoute(
            name: "UnitsTemplate",
            pattern: "{*uri}",
            defaults: new { controller = "UnitsTemplate", action = "UnitsTemplate" });

        endpoints.MapControllerRoute(
            name: "UnitsSubMenuTemplate",
            pattern: "/universitemiz/{mainPath}/{menuPath}/{subMenuPath}",
            defaults: new { controller = "UnitsTemplate", action = "UnitsSubMenuTemplate" });
